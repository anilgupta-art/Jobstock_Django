            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-12 col-md-12">
                        <h2 className="ipt-title">Grid Style Jobs 03</h2>
                        <div className="breadcrumbs light">
                            <nav aria-label="breadcrumb">
                                <ol className="breadcrumb">
                                    <li className="breadcrumb-item"><Link href="#">Home</Link></li>
                                    <li className="breadcrumb-item"><Link href="#">Candidate</Link></li>
                                    <li className="breadcrumb-item active" aria-current="page">Job Grid 03</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
									...
									<div className="jbs-grid-layout style_2 border">
										<div className="jbs-grid-emp-head">
											<div className="jbs-grid-emp-content">
												<div className="jbs-grid-emp-thumb"><Link href={`/job-detail/${item.id}`}><figure><img src={item.image} className="img-fluid" alt=""/></figure></Link></div>
