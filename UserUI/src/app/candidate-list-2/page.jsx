...
export default function CandidateListTwo() {
  return (
    <>
        <NavBgBlack/>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-12 col-md-12">
                        <h2 className="ipt-title">Candidate List Style 02</h2>
                        <div className="breadcrumbs light">
                            <nav aria-label="breadcrumb">
                                <ol className="breadcrumb">
                                    <li className="breadcrumb-item"><Link href="#">Home</Link></li>
                                    <li className="breadcrumb-item"><Link href="#">Candidate</Link></li>
                                    <li className="breadcrumb-item active" aria-current="page">Candidate List 02</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
									...
									<div className="jbs-list-box border">
										<div className="jbs-list-head m-0">
											...
											<div className="jbs-list-head-middle">
												<div className="elsocrio-jbs sm"><div className="ilop-tr"><i className="fa-solid fa-coins"></i></div><h5 className="jbs-list-pack">7 Years Exp.</h5></div>
											</div>
