...
export default function Navlight() {
  ...
  return (
    <>
        <div className={`header header-transparent change-logo ${scroll ? 'header-fixed' : ''}`}>
            <div className="container">
                <nav id="navigation" className={windowWidth > 991 ? "navigation navigation-landscape" : "navigation navigation-portrait"}>
                    <div className="nav-header">
                        <Link className="nav-brand static-logo" href="#"><img src='/img/logo-light.png' className="logo" alt=""/></Link>
                        <Link className="nav-brand fixed-logo" href="#"><img src='/img/logo.png' className="logo" alt=""/></Link>
                            ...
                            <li className={`nav-submenu-open ${['/grid-style-1','/grid-style-2','/grid-style-3','/grid-style-4','/grid-style-1','/full-job-grid-1','/full-job-grid-2','/list-style-1','/list-style-2','/list-style-3','/full-job-list-1','/full-job-list-2','/half-map','/half-map-2','/half-map-3','/half-map-list-1','/half-map-list-2','/candidate-grid-1','/candidate-grid-2','/candidate-list-1','/candidate-list-2','/candidate-half-map','/candidate-half-map-list','/single-layout-1','/single-layout-2','/single-layout-3','/single-layout-4','/job-detail','/single-layout-6','/candidate-detail','/candidate-detail-2','/candidate-detail-3','/advance-search','/candidate-dashboard'].includes(menu) ? 'active' : ''}`}><Link href="#">For Candidate<span className="submenu-indicator"><span className='submenu-indicator-chevron'></span></span></Link>
                                <ul className="nav-dropdown nav-submenu">
                                    <li className={`nav-submenu-open ${['/grid-style-1','/grid-style-2','/grid-style-3','/grid-style-4','/grid-style-1','/full-job-grid-1','/full-job-grid-2','/list-style-1','/list-style-2','/list-style-3','/full-job-list-1','/full-job-list-2'].includes(menu) ? 'active' : ''}`}><Link href="#">Browse Jobs<span className="submenu-indicator"><span className='submenu-indicator-chevron'></span></span></Link>
                                        <ul className="nav-dropdown nav-submenu">
                                            <li><Link href="/grid-style-1">Job Grid Style 1</Link></li>                                    
                                            <li><Link href="/grid-style-2">Job Grid Stle 2</Link></li>                                    
                                            <li><Link href="/grid-style-3">Job Grid Style 3</Link></li>
                                            <li><Link href="/grid-style-4">Job Grid Style 4</Link></li>
                                            <li><Link href="/grid-style-5">Job Grid Style 5</Link></li>												
                                            <li><Link href="/full-job-grid-1">Grid Full Style 1</Link></li>
                                            <li><Link href="/full-job-grid-2">Grid Full Style 2</Link></li>
                                            <li><Link href="/list-style-1">Job List Style 1</Link></li>
                                            <li><Link href="/list-style-2">Job List Style 2</Link></li>
                                            <li><Link href="/list-style-3">Job List Style 3</Link></li>
                                            <li><Link href="/full-job-list-1">List Full Style 1</Link></li>
                                            <li><Link href="/full-job-list-2">List Full Style 2</Link></li>												
                                        </ul>
                                    </li>
                                    <li className={`nav-submenu-open ${['/half-map','/half-map-2','/half-map-3','/half-map-list-1','/half-map-list-2'].includes(menu) ? 'active' : ''}`}><Link href="#">Browse Map Jobs<span className="submenu-indicator"><span className='submenu-indicator-chevron'></span></span></Link>
                                        <ul className="nav-dropdown nav-submenu">
                                            <li><Link href="/half-map">Job Search on Map 01</Link></li>                                    
                                            <li><Link href="/half-map-2">Job Search on Map 02</Link></li>                                    
                                            <li><Link href="/half-map-3">Job Search on Map 03</Link></li>
                                            <li><Link href="/half-map-list-1">Job Search on Map 04</Link></li>
                                            <li><Link href="/half-map-list-2">Job Search on Map 05</Link></li>
                                        </ul>
                                    </li>
                                    <li className={`nav-submenu-open ${['/candidate-grid-1','/candidate-grid-2','/candidate-list-1','/candidate-list-2','/candidate-half-map','/candidate-half-map-list'].includes(menu) ? 'active' : ''}`}><Link href="#">Browse Candidate<span className="submenu-indicator"><span className='submenu-indicator-chevron'></span></span></Link>
                                        <ul className="nav-dropdown nav-submenu">
                                            <li><Link href="/candidate-grid-1">Candidate Grid 01</Link></li>                                    
                                            <li><Link href="/candidate-grid-2">Candidate Grid 02</Link></li>                                    
                                            <li><Link href="/candidate-list-1">Candidate List 01</Link></li>                                    
                                            <li><Link href="/candidate-list-2">Candidate List 02</Link></li>
                                            <li><Link href="/candidate-half-map">Candidate Half Map 01</Link></li>
                                            <li><Link href="/candidate-half-map-list">Candidate Half Map 02</Link></li>												
                                        </ul>
                                    </li>
