...
import { footerCounter, footerLink2, footerLink3, footerSocial } from '../../data/data'

export default function FooterLightTwo() {
  return (
                ...
                <div className="row">
                    <div className="col-lg-3 col-md-4">
                        <div className="footer-widget">
                            <img src='/img/logo.png' className="img-footer" alt=""/>
