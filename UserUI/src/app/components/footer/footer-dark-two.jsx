...
import { footerCounter, footerLink1, footerLink2, footerLink3, footerSocial } from '../../data/data'

export default function FooterDarkTwo() {
  return (
            <footer className="footer skin-dark-footer bg-second">
				<div className="position-absolute top-0 end-0">
					<img src='/img/shape-3-soft-light.svg' alt="SVG" width="500"/>
				</div>
				<div className="position-absolute top-0 start-0 me-10">
					<img src='/img/shape-1-soft-light.svg' alt="SVG" width="250"/>
				</div>
						...
						<div className="row align-items-center justify-content-between">
							...
							<div className="col-xl-7 col-lg-7 col-md-7">
								<div className="job-info-count-group lg-ctr">
                                    {footerCounter.map((item,index)=>( 
                                        <div className="single-jb-info-count" key={index}>
                                            <div className="jbs-y7"><h5 className="ctr"><CountUp end={item.value}/></h5><span className="text-main">{item.symbol}</span></div>
                                            <div className="jbs-y5"><p>{item.title}</p></div>
                                        </div>
                                    ))}
								</div>
							</div>
						...
						<div className="row">
							...
							<div className="col-lg-3 col-md-4">
								<div className="footer-widget">
									<img src='/img/logo-light.png' className="img-footer" alt=""/>
									...
									<div className="foot-socials">
										<ul>
                                            {footerSocial.map((item, index)=>( 
                                                <li key={index}><Link href="#"><i className={item}></i></Link></li>
                                            ))}
                                        </ul>
									</div>
								</div>
							...
							<div className="col-lg-2 col-md-4">
								<div className="footer-widget">
									<h4 className="widget-title text-white">For Clients</h4>
							...
							<div className="col-lg-2 col-md-4">
								<div className="footer-widget">
									<h4 className="widget-title text-white">Our Resources</h4>
									<ul className="footer-menu">
							...
							<div className="col-lg-2 col-md-6">
								<div className="footer-widget">
									<h4 className="widget-title text-white">The Company</h4>
									<ul className="footer-menu">
							...
							<div className="col-lg-3 col-md-6">
								<div className="footer-widget">
									<h4 className="widget-title text-white">Download Apps</h4>	
					...
					<div className="container">
						<div className="row align-items-center justify-content-center">
                            <div className="col-xl-4 col-lg-5 col-md-5">
                                <p className="mb-0 text-center">© {new Date().getFullYear()}  JobStock Design & Develop By <i className="fa-solid fa-heart text-red"></i> <Link href="https://shreethemes.in/" target='blank' className='text-white'>Shreethemes</Link>.</p>
                            </div>
						</div>
					</div>
				</div>
				<div className="position-absolute bottom-0 start-0">
					<img src='/img/shape-2-soft-light.svg' alt="SVG" width="400"/>
				</div>
			</footer>
  )
}
