                        ...
                        <div className="jbs-head-bodys-top my-5">
                            <div className="jbs-roots-y1 flex-column justify-content-start align-items-start">
                                <div className="jbs-roots-y1-last">
                                    <div className="jbs-urt mb-2"><span className="label text-secondcolor bg-white rounded-pill">Full Time</span></div>
                                    <div className="jbs-title-iop mb-1"><h2 className="m-0 fs-2 text-light">Sr. Front-end Designer</h2></div>
