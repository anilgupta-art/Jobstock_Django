...
export default function GridStyleFive() {
  return (
    <>
        <NavBgBlack/>   
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-12 col-md-12">
                        <h2 className="ipt-title">Grid Style Jobs 05</h2>
                        <div className="breadcrumbs light">
                            <nav aria-label="breadcrumb">
                                <ol className="breadcrumb">
                                    <li className="breadcrumb-item"><Link href="#">Home</Link></li>
                                    <li className="breadcrumb-item"><Link href="#">Candidate</Link></li>
                                    <li className="breadcrumb-item active" aria-current="page">Job Grid 05</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            {jobData.slice(0,8).map((item,index)=>( 
                                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12" key={index}>
                                    <div className="jbs-grid-layout border">
                                        ...
                                        <div className="jbs-grid-job-info-wrap">
											<div className="jbs-grid-job-info">
												<div className="jbs-grid-single-info"><span><i className="fa-solid fa-user-group"></i>1-2 Year</span></div>
												<div className="jbs-grid-single-info"><span><i className="fa-regular fa-clock"></i>{item.jobtype}</span></div>
												<div className="jbs-grid-single-info"><span><i className="fa-solid fa-location-dot"></i>{item.location}</span></div>
											</div>
										</div>
