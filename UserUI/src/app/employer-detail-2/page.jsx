...
export default function EmployerDetailTwo() {
  return (
    <>  
        ...
        <section className="bg-second position-relative">
            <div className="position-absolute top-0 start-0 opacity-50">
					<Image src='/img/circle.png' alt="SVG" width={150} height={150}/>
				</div>
                        ...
                        <div className="emplr-head-block">
                            ...
                            <div className="emplr-head-left">
                                <div className="emplr-head-thumb">
                                    <figure><Image src='/img/l-1.png' width={120} height={120} className="img-fluid" alt="" style={{borderRadius:'50%'}}/></figure>
                                </div>
                                <div className="emplr-head-caption">
                                    <div className="emplr-head-caption-top">
                                        <div className="emplr-yior-1"><span className="label text-sm-muted text-light bg-warning">10 Openings</span></div>
                                        <div className="emplr-yior-2"><h4 className="emplr-title text-light">Tripadvisor Inc.</h4></div>
                                        <div className="emplr-yior-3 justify-content-start">
                                            <span className="text-light opacity-75"><i className="fa-solid fa-building-shield me-1"></i>Software</span>
                                            <span className="text-light opacity-75"><i className="fa-solid fa-location-dot me-1"></i>Canada, USA</span>
                            ...
                            <div className="single-cdtsr-block">
                                ...
                                <div className="single-cdtsr-body">
                                    <div className="cndts-all-skills-list">
                                        {comapnyServices.map((item,index)=>( 
