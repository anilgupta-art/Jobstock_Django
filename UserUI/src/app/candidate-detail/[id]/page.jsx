...
export default function CandidateDetail({params}) {
    ...
    let data = candidateData.find((item)=>item.id === parseInt(id))
                        ...
                        <div className="cndt-head-block">
                            <div className="cndt-head-left">
                                <div className="cndt-head-thumb">
                                    <figure><Image src={data && data.image} width={150} height={150} className="img-fluid circle" alt=""/></figure>
                                </div>
                                <div className="cndt-head-caption">
                                    <div className="cndt-head-caption-top">
                                        <div className="cndt-yior-1"><span className="label text-sm-muted text-success bg-success bg-opacity-05">Featured</span></div>
                                        <div className="cndt-yior-2"><h4 className="cndt-title">{data && data.name}</h4></div>
                                        <div className="cndt-yior-3">
                                            <span><i className="fa-solid fa-user-graduate me-1"></i>{data && data.position}</span>
                                            <span><i className="fa-solid fa-location-dot me-1"></i>{data && data.loction}</span>
                            ...
                            <div className="cndt-head-right">
                                ...
                                <button type="button" className="btn btn-outline-main ms-2"><i className="fa-solid fa-bookmark"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="single-cdtsr-block">
                                ...
                                <div className="single-cdtsr-body">
                                    <div className="row justify-content-start gx-3 gy-4">
                                        {candidateData.slice(0,4).map((item,index)=>( 
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-12">
                        <div className="sidefr-usr-block mb-4">
                            <div className="sidefr-usr-header">
                                <h4 className="sidefr-usr-title">Contact {data && data.name}</h4>
                            </div>
