                        ...
                        <div className="cndt-head-block">
                            <div className="cndt-head-left">
                                <div className="cndt-head-thumb">
                                    <figure><Image src='/img/avatar.jpg' width={150} height={150} className="img-fluid circle" alt=""/></figure>
                                </div>
                                <div className="cndt-head-caption">
                                    <div className="cndt-head-caption-top">
                                        ...
                                        <div className="cndt-yior-2"><h4 className="cndt-title">Dhananjay Preet</h4></div>
